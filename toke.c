...
} const debug_tokens[] =
{
	...
	DEBUG_TOKEN (NONE, REQUIRE),
	DEBUG_TOKEN (OPNUM, SHIFTOP),
	DEBUG_TOKEN (NONE, SIGSUB),
	DEBUG_TOKEN (NONE, SUB),
	DEBUG_TOKEN (NONE, SUBLEXEND),
	DEBUG_TOKEN (NONE, SUBLEXSTART),
	DEBUG_TOKEN (OPVAL, THING),
	DEBUG_TOKEN (IVAL, TRY),
	DEBUG_TOKEN (NONE, UMINUS),
	DEBUG_TOKEN (OPNUM, UNIOP),
	DEBUG_TOKEN (OPVAL, UNIOPSUB),
	DEBUG_TOKEN (IVAL, UNLESS),
	DEBUG_TOKEN (IVAL, UNTIL),
	DEBUG_TOKEN (IVAL, USE),
	DEBUG_TOKEN (IVAL, WHEN),
	DEBUG_TOKEN (IVAL, WHILE),
